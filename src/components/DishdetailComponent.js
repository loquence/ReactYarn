...
import { Card, CardImg, CardText, CardBody, CardTitle, Breadcrumb, BreadcrumbItem, Modal, Button, ModalHeader, 
    ...
    render(){
        ...
        <>
            ...
            <Modal isOpen={this.state.isModalOpen} toggle={this.toggleModal}>
                    ...
                    <ModalBody>
                    <LocalForm name="modalform" onSubmit={(values) => this.handleSubmit(values)}>
